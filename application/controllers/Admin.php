...
class Admin extends CI_Controller
{
	...
	function hasil_tes(){
		...
		if ($cek > 0) {		
			$res = $this->Admin_model->query("SELECT a.nama, b.nama as pekerjaan, c.jawaban, c.hasil, c.waktu, c.status FROM tbl_user a LEFT JOIN tbl_pekerjaan b ON a.id_pekerjaan = b.id LEFT JOIN tbl_uji c ON a.username = c.username WHERE a.username = '$username'")[0];
