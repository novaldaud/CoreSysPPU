...
class User extends CI_Controller
{
	...
	function index(){
		...
		$data['data'] = $this->User_model->query("SELECT a.nama, b.nama as pekerjaan FROM tbl_user a LEFT JOIN tbl_pekerjaan b ON a.id_pekerjaan = b.id WHERE a.username = '$username'")[0];
	...
	function hasil_tes(){
		...
		if ($cek > 0) {		
			$res = $this->User_model->query("SELECT a.nama, b.nama as pekerjaan, c.hasil, c.waktu, c.status FROM tbl_user a LEFT JOIN tbl_pekerjaan b ON a.id_pekerjaan = b.id LEFT JOIN tbl_uji c ON a.username = c.username WHERE a.username = '$username'")[0];
