        ...
        <div class="card-body">
            ...
            <?php
             ...
             <div class="text-right">
                ...
                <button type="button" onclick="printJS({ printable: 'printJS-form', type: 'html', header: 'Hasil Personality Assessment' })" class="btn btn-info col-lg-2"><i class="fa fa-print"></i> Cetak</button>
            </div>
        </div>
    </div>
