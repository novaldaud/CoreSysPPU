...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
       <a class="navbar-brand" href="">Platform Personality Assessment<span></span></a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active"><a href="<?php echo base_url() ?>public/Pages/tata_cara" class="nav-link">Tata Cara</a></li>
              <li class="nav-item"><a href="<?php echo base_url() ?>public/Pages/Cari_Data" class="nav-link">Cari Data</a></li>
               <li class="nav-item cta"><a href="contact.html" class="nav-link" data-toggle="modal" data-target="#modalRequest"><span>Mulai Test</span></a></li>
            </ul>
          </ul>
        </div>
      </div>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item bread-item" style="background-image: url('<?php echo base_url() ?>asset/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section">
      <div class="container">  
       <div align="center">
         <h3 style="font-family:auto">Tata Cara Penggunaan Platform Personality Assessment</h3>
       </div>
      </div>
    </section>
    ...
    <section class="ftco-section-2">
      <div class="container-wrap">
        <div class="row d-flex no-gutters">
          <div class="col-md-6 img" style="background-image: url(<?php echo base_url() ?>asset/images/about-2.jpg);">
          </div>
          <div class="col-md-6 d-flex">
            <div class="about-wrap">
              ...
              <div class="list-services d-flex ftco-animate">
                ...
                <div class="text">
                  <h3>Mulai Test</h3>
                  <p>Pilih Mulai Tes dan Login dengan Email Dan Password yang Telah Di daftarkan Sebelumnya.</p>
                </div>
              </div>
              <div class="list-services d-flex ftco-animate">
                <div class="icon d-flex justify-content-center align-items-center">
        ...
        <div class="modal-body">
          <form id="frm_login">
            ...
            <div class="form-group" align="right">
              <button  class="btn btn-primary" type="submit" name="submit">Login dan Mulai Ujian</button>
    ...
    <script type="text/javascript">
        $('#frm_login').submit(function(e){
           ...
           e.stopImmediatePropagation();
            var dataUrl ="<?php echo base_url('public/Daftar/login') ?>";
            ...
            $.ajax({
              ...
              async:false,
                  ...
                  if (result=="OK") {
                     ...
                     judul='Success';
                     teks='Berhasil Login';
                     aksi=window.location.href="<?php echo base_url() ?>public/Pages/ujian";
                    }else{
                             ikon='error'; 
                             judul='Oops.!';
                             teks=result;
                             aksi= console.log(result);
                    }
                      Swal.fire({
                              title:judul,
                              text:teks,
